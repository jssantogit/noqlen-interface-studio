...
- Anchor has implemented Home, Servers, Library, dedicated Navidrome Settings and Activity mock interactions; visible interaction gaps are closed, and state coverage polish remains the next Anchor block.
