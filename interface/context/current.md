...
Bloco 1 aligns the interface studio with the mobile simulator concept. Bloco 1.1 hardens the responsive shell around that simulator without starting app-specific screens. Bloco 1.3 refines the simulator frame so it reads closer to premium smartphone hardware.
