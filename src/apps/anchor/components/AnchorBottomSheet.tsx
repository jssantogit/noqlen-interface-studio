...
export function AnchorBottomSheet({
  children,
  onClose,
  subtitle,
  title,
  ...
  return (
    <div className="absolute inset-0 z-40 flex min-w-0 items-end overflow-hidden bg-black/48 px-2 pb-0 pt-8 backdrop-blur-[2px]">
      <button
      ...
      <section
        aria-modal="true"
        className="relative max-h-[86%] w-full min-w-0 overflow-hidden rounded-t-[1.65rem] border border-white/[0.09] bg-[linear-gradient(180deg,rgba(18,31,38,0.98),rgba(6,13,18,0.99))] shadow-[0_-1.2rem_3rem_rgba(0,0,0,0.45),inset_0_1px_0_rgba(255,255,255,0.07)]"
        role="dialog"
      >
        ...
        <div className="max-h-[calc(86vh-6rem)] min-w-0 overflow-y-auto overflow-x-hidden px-5 pb-6">
          {children}
        </div>
      </section>
    </div>
