...
export function AnchorCard({
  ...
  return (
    <section
      className={`rounded-[1.15rem] border border-white/[0.075] bg-[linear-gradient(145deg,rgba(255,255,255,0.075),rgba(255,255,255,0.032))] shadow-[0_1.1rem_2rem_rgba(0,0,0,0.2),inset_0_1px_0_rgba(255,255,255,0.045)] ${className}`}
    >
      {children}
    </section>
  )
  ...
  return (
    <header className="mb-5 flex items-start justify-between gap-4">
      <div className="min-w-0">
        <h1 className="font-serif text-[2rem] leading-none tracking-[-0.055em] text-white">
          {title}
        </h1>
