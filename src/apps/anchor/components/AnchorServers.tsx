...
export function AnchorServers() {
  ...
  return (
    <div className="px-5 pt-5">
      <AnchorScreenHeader
        action={
          <AnchorIconButton label="Add server">
          ...
          <div className="min-w-0 flex-1">
            <div className="flex min-w-0 items-start justify-between gap-2">
              <div className="min-w-0">
                <h2 className="truncate text-base font-semibold text-white">{navidrome.name}</h2>
                <p className="mt-1 truncate text-xs text-slate-300/76">
                  {navidrome.description}
                </p>
              </div>
              <span className="shrink-0 rounded-full bg-emerald-400/14 px-2.5 py-1 text-[0.66rem] font-medium text-emerald-300">
