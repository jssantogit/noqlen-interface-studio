 ...
 * interaction IDs, implementation statuses, notes and batch groupings.
 */
...
export const ariaInteractions: AriaInteraction[] = [
  ...
  { id: 'GL-4', name: 'Play / Pause', screen: 'global', status: 'implemented', batch: 1, mockOnly: true, notes: 'Visual toggle with toast feedback' },
  ...
  // Listen (Home)
  { id: 'LS-1', name: 'Recent Listen Shelf', screen: 'listen', status: 'implemented', batch: 1, mockOnly: true, notes: 'Recent additions list with curated tracks' },
  ...
  { id: 'LB-2', name: 'Album Row Tap', screen: 'library', status: 'implemented', batch: 4, mockOnly: true, notes: 'Opens Album Detail using local state' },
  { id: 'LB-3', name: 'Artist Row Tap', screen: 'library', status: 'implemented', batch: 4, mockOnly: true, notes: 'Opens Artist Detail using local state' },
  { id: 'LB-4', name: 'Song Row Tap', screen: 'library', status: 'implemented', batch: 2, mockOnly: true, notes: 'Opens Track Details using local state' },
  { id: 'LB-5', name: 'Library Search', screen: 'library', status: 'not_implemented', batch: 3, mockOnly: true },
  { id: 'LB-6', name: 'Library Sort / Filter', screen: 'library', status: 'partial', batch: 3, mockOnly: true, notes: 'Sort/filter affordance exists as UI feedback' },

  // Playlists
  { id: 'PL-1', name: 'Playlist Row Tap', screen: 'playlists', status: 'implemented', batch: 4, mockOnly: true, notes: 'Opens Playlist Detail using local state' },
  { id: 'PL-2', name: 'Create Playlist', screen: 'playlists', status: 'implemented', batch: 4, mockOnly: true, notes: 'Action feedback' },
  { id: 'PL-3', name: 'Playlist Detail Play', screen: 'playlistDetail', status: 'implemented', batch: 2, mockOnly: true, notes: 'Toast and local visual feedback' },
  { id: 'PL-4', name: 'Playlist Detail Shuffle', screen: 'playlistDetail', status: 'implemented', batch: 2, mockOnly: true, notes: 'Toast and local visual feedback' },
  ...
  { id: 'EX-3', name: 'Search Result Tap', screen: 'explore', status: 'partial', batch: 6, mockOnly: true, notes: 'Discovery/category taps can open detail screens; full search results remain future work' },
  { id: 'EX-4', name: 'Recent Searches', screen: 'explore', status: 'not_implemented', batch: 6, mockOnly: true },

  // Album Detail
  { id: 'AD-1', name: 'Play Album', screen: 'albumDetail', status: 'implemented', batch: 2, mockOnly: true, notes: 'Toast and local state feedback' },
  { id: 'AD-2', name: 'Shuffle Album', screen: 'albumDetail', status: 'implemented', batch: 2, mockOnly: true, notes: 'Toast and local state feedback' },
  { id: 'AD-3', name: 'More Menu on Album', screen: 'albumDetail', status: 'implemented', batch: 4, mockOnly: true, notes: 'Toast feedback' },
  { id: 'AD-4', name: 'Track Row Tap in Album', screen: 'albumDetail', status: 'implemented', batch: 2, mockOnly: true, notes: 'Opens Track Details using local state' },
  { id: 'AD-5', name: 'Track More Menu in Album', screen: 'albumDetail', status: 'implemented', batch: 4, mockOnly: true, notes: 'Toast feedback' },

  // Artist Detail
  { id: 'AR-1', name: 'Play Top Tracks', screen: 'artistDetail', status: 'implemented', batch: 2, mockOnly: true, notes: 'Toast and local state feedback' },
  { id: 'AR-2', name: 'Album Tap in Discography', screen: 'artistDetail', status: 'implemented', batch: 4, mockOnly: true, notes: 'Opens Album Detail or discography feedback using local state' },
  { id: 'AR-3', name: 'More Menu on Artist', screen: 'artistDetail', status: 'implemented', batch: 4, mockOnly: true, notes: 'Toast feedback' },

  // Track Details
  { id: 'TD-1', name: 'Favorite Action', screen: 'trackDetails', status: 'implemented', batch: 2, mockOnly: true, notes: 'Toast/action feedback' },
  { id: 'TD-2', name: 'Add to Playlist', screen: 'trackDetails', status: 'implemented', batch: 4, mockOnly: true, notes: 'Toast/action feedback' },
  { id: 'TD-3', name: 'Add to Queue', screen: 'trackDetails', status: 'implemented', batch: 2, mockOnly: true, notes: 'Toast/action feedback' },
  { id: 'TD-4', name: 'Show in Folder', screen: 'trackDetails', status: 'implemented', batch: 4, mockOnly: true, notes: 'Toast/action feedback' },
  ...
  // Mini Player
  { id: 'MP-1', name: 'Mini Player Play/Pause', screen: 'global', status: 'implemented', batch: 2, mockOnly: true, notes: 'Visual toggle with toast feedback' },
  { id: 'MP-2', name: 'Mini Player Next/Previous', screen: 'global', status: 'partial', batch: 2, mockOnly: true, notes: 'Visible controls with toast; no queue cycling yet' },
]
