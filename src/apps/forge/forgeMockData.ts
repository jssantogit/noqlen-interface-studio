...
export const albumData: MockAlbum[] = [
  {
    ...
    mbAlbumId: 'mbid-all-melody-2018',
    mbReleaseGroupId: 'rgid-all-melody-2018',
    label: 'Erased Tapes',
  ...
  },
  {
    ...
    mbAlbumId: 'mbid-spaces-2013',
    mbReleaseGroupId: 'rgid-spaces-2013',
    label: 'Erased Tapes',
  ...
  },
  {
    ...
    mbAlbumId: 'mbid-the-bells-2009',
    mbReleaseGroupId: 'rgid-the-bells-2009',
    label: 'Erased Tapes',
  ...
  },
  {
    ...
    mbAlbumId: 'mbid-music-for-animals-2022',
    mbReleaseGroupId: 'rgid-music-for-animals-2022',
    label: 'LEITER',
  ...
  },
  {
    ...
    mbAlbumId: 'mbid-felt-2011',
    mbReleaseGroupId: 'rgid-felt-2011',
    label: 'Erased Tapes',
  ...
  },
  {
    ...
    mbAlbumId: 'mbid-empty-2020',
    mbReleaseGroupId: 'rgid-empty-2020',
    label: 'LEITER',
...
export const songData: MockSong[] = [
  {
    ...
    syncedLyrics: '',
    sidecarLrc: '',
    mbTrackId: 'mbid-track-whole-universe',
    mbReleaseTrackId: 'mbid-release-track-whole-universe',
    acoustId: 'acoustid-whole-universe',
    isrc: 'isrc-2018-0001',
    bpm: '72',
    key: 'A minor',
    energy: 'Low',
    ...
    filePath: 'Nils Frahm/All Melody/01 The Whole Universe Wants.flac',
    fileFormat: 'FLAC',
    codec: 'FLAC',
    bitrate: '1411 kbps',
    sampleRate: '44.1 kHz',
  ...
  },
  {
    ...
    syncedLyrics: '',
    sidecarLrc: '',
    mbTrackId: 'mbid-track-says',
    mbReleaseTrackId: 'mbid-release-track-says',
    acoustId: 'acoustid-says',
    isrc: 'isrc-2013-0002',
    bpm: '120',
    key: 'A minor',
    energy: 'Medium',
    ...
    filePath: 'Nils Frahm/Spaces/02 Says.flac',
    fileFormat: 'FLAC',
    codec: 'FLAC',
    bitrate: '1411 kbps',
    sampleRate: '44.1 kHz',
  ...
  },
  {
    ...
    syncedLyrics: '',
    sidecarLrc: '',
    mbTrackId: 'mbid-track-a-place',
    mbReleaseTrackId: 'mbid-release-track-a-place',
    acoustId: 'acoustid-a-place',
    isrc: 'isrc-2018-0003',
    bpm: '65',
    key: 'C major',
    energy: 'Low',
    ...
    replayGainAlbumGain: '-8.5 dB',
    replayGainAlbumPeak: '0.99',
    filePath: 'Nils Frahm/All Melody/03 A Place.flac',
    fileFormat: 'FLAC',
    codec: 'FLAC',
    bitrate: '1411 kbps',
    sampleRate: '44.1 kHz',
  ...
  },
  {
    ...
    syncedLyrics: '',
    sidecarLrc: '',
    mbTrackId: 'mbid-track-sunson',
    mbReleaseTrackId: 'mbid-release-track-sunson',
    acoustId: 'acoustid-sunson',
    isrc: 'isrc-2018-0004',
    bpm: '88',
    key: 'F major',
    energy: 'Medium',
    ...
    replayGainAlbumGain: '-8.5 dB',
    replayGainAlbumPeak: '0.99',
    filePath: 'Nils Frahm/All Melody/02 Sunson.flac',
    fileFormat: 'FLAC',
    codec: 'FLAC',
    bitrate: '1411 kbps',
    sampleRate: '44.1 kHz',
  ...
  },
  {
    ...
    syncedLyrics: '',
    sidecarLrc: '',
    mbTrackId: 'mbid-track-hammers',
    mbReleaseTrackId: 'mbid-release-track-hammers',
    acoustId: 'acoustid-hammers',
    isrc: 'isrc-2013-0005',
    bpm: '135',
    key: 'D minor',
    energy: 'High',
    ...
    replayGainAlbumGain: '-8.1 dB',
    replayGainAlbumPeak: '0.98',
    filePath: 'Nils Frahm/Spaces/03 Hammers.flac',
    fileFormat: 'FLAC',
    codec: 'FLAC',
    bitrate: '1411 kbps',
    sampleRate: '44.1 kHz',
  ...
  },
  {
    ...
    syncedLyrics: '',
    sidecarLrc: '',
    mbTrackId: 'mbid-track-my-friend',
    mbReleaseTrackId: 'mbid-release-track-my-friend',
    acoustId: 'acoustid-my-friend',
    isrc: 'isrc-2018-0006',
    bpm: '60',
    key: 'E minor',
    energy: 'Low',
    ...
    replayGainAlbumGain: '-8.5 dB',
    replayGainAlbumPeak: '0.99',
    filePath: 'Nils Frahm/All Melody/04 My Friend the Forest.flac',
    fileFormat: 'FLAC',
    codec: 'FLAC',
    bitrate: '1411 kbps',
    sampleRate: '44.1 kHz',
...
export const activityItems: ActivityItem[] = [
  ...
  },
  {
    ...
    summary: ['Says'],
    detail: 'BPM, key, energy and danceability were updated from audio analysis.',
    activityType: 'audio',
    dateGroup: 'today',
    affectedCount: 1,
    affectedItems: ['Says'],
  ...
  },
  {
    ...
    detail: 'Forge scanned the library and left everything unchanged.',
