...
export function PhoneFrame({
  ...
  return (
    ...
    >
      ...
      <div className="relative h-full w-full min-w-0 max-w-full overflow-hidden rounded-[calc(var(--studio-phone-radius)-5px)] bg-black p-[var(--phone-frame-bezel)] shadow-[inset_0_0_0_1px_rgba(255,255,255,0.045),inset_0_1rem_1.8rem_rgba(255,255,255,0.025),inset_0_-1rem_2rem_rgba(0,0,0,0.78)]">
