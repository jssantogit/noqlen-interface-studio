...
export function AppSwitcher({
  ...
  return (
    <nav
      ...
      className="rounded-[1.35rem] border border-white/10 bg-black/20 p-1.5 backdrop-blur-xl sm:rounded-[1.5rem] sm:p-2"
    >
      <div className="grid grid-cols-2 gap-1.5 sm:grid-cols-4 sm:gap-2 lg:grid-cols-1">
        {apps.map((app) => {
          ...
          return (
            <button
              ...
              className={cn(
                'min-h-12 rounded-2xl border px-3 py-2.5 text-left transition sm:py-3',
            ...
            >
              ...
              <span className="mt-0.5 block text-xs leading-4 text-slate-400 sm:mt-1">
                {app.mood}
              </span>
            </button>
          )
